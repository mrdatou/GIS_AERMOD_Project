...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        self.sheet = Sheet(None, master=self.__imframe)
        self.sheet.grid(row=2, column=0, columnspan=2, sticky='we')
...
class Sheet(tksheet.Sheet):
    ...
    def selected_row(self, event):
        ...
        if not self.current_selected_id is None:
            self.master.master.master.canvas.deselect_polyline(self.current_selected_id)

        self.current_selected_id = self.get_row_data(self.get_selected_rows().pop())[5]

        # Change color of selected line
        self.master.master.master.canvas.selected_polyline(self.current_selected_id)
    ...
    def delete_row(self, event):
        ...
        self.master.master.master.canvas.delete_selected_polyline(self.current_selected_id)
        self.current_selected_id = None